        ...
        <>
            ...
            <div>
                                ...
                                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                                    ...
                                    >
                                        <div className="absolute left-full top-0 flex w-16 justify-center pt-5">
                                            ...
                                            >
                                                <IconX className="size-6 text-white" aria-hidden="true" />
                                            </button>
                                        </div>
                                    </Transition.Child>

                                    <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gradient-to-b from-indigo-500 via-indigo-600 to-indigo-700 px-6 pb-2">
                                        {/* {sidebar responsive} */}
                ...
                <div className="hidden p-2.5 lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
                    <div className="flex grow flex-col gap-y-5 overflow-y-auto rounded-xl border bg-gradient-to-b from-indigo-500 via-indigo-600 to-indigo-700 px-4">
                        <Sidebar url={url} />
                    </div>
                </div>
